  ...
  <div>
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control"  placeholder="Avenida, Rua" value=<?php echo $info_user[0]->address?>>
      </div>
    </div>
    <div class="form-row">
    <div class="form-group col-md-6">
          <label for="inputTel">Telefone</label>
          <input  type="tel" class="form-control" placeholder="(53)99923-3659"  placeholder="00.000.000/0000-00" onkeypress="$(this).mask('00.000.000/0000-00')" onkeypress="$(this).mask('(00) 0000-00009')"s value=<?php echo $info_user[0]->phone?>>
        </div>
      <div class="form-group col-md-6">
        <label for="exampleFormControlSelect1">Especialidade:</label>
        <select class="form-control" id="exampleFormControlSelect1" value=<?php echo $info_user[0]->specialty?>>
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" placeholder="00000000" value=<?php echo $info_user[0]->crm?>>
      </div>
    </div> 
